...
@extends('layout/default')
    ...
    <main >
        <div class="alert alert-warning">
            ...
            <p>"Merci pour avoir soumis votre demande de stage! Nous avons bien reçu votre formulaire et nous vous recontacterons sous peu pour la suite du processus. Nous apprécions votre intérêt pour rejoindre notre équipe!"</p>
        </div>
        <div>
